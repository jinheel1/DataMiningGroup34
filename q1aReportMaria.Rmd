...
The first method explored is Principal Component Analysis (PCA), PCA is used as a technique to emphasize variation and highllight strong patterns in data. This also makes it easy to explore and visualize. 
...
names(pc.n)
summary(pc.n)
#PC1 explains 11% #PC50 explains 90% #PC65 explains 95% #PC92 explains 99%
```
...
cat("Error:", round(kmed_error.65.2 * 100, 2), "%")
cat("Error:", round(kmed_error.65.4 * 100, 2), "%")
```
